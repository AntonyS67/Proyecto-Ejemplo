...
class GestorArticulosModel{
	...
	public function guardarArticuloModel($datosModel, $tabla){
		$con=new Conexion();
		$stmt = $con->conectar()->prepare("INSERT INTO $tabla (titulo, introduccion, ruta, contenido) VALUES (:titulo, :introduccion, :ruta, :contenido)");
	...
	public function editarArticuloModel($datosModel, $tabla){
		$con=new Conexion();
		$stmt = $con->conectar()->prepare("UPDATE $tabla SET titulo = :titulo, introduccion = :introduccion, ruta = :ruta, contenido = :contenido WHERE id = :id");	
