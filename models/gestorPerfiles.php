...
class GestorPerfilesModel{
	...
	public function guardarPerfilModel($datosModel, $tabla){
		$con=new Conexion();
		$stmt = $con->conectar()->prepare("INSERT INTO $tabla (usuario, password, email, photo, rol) VALUES (:usuario, :password, :email, :photo, :rol)");
	...
	public function verPerfilesModel($tabla){
		$con=new Conexion();
		$stmt = $con->conectar()->prepare("SELECT id, usuario, password,  email, rol, photo FROM $tabla");
	...
	public function editarPerfilModel($datosModel, $tabla){
		$con=new Conexion();
		$stmt = $con->conectar()->prepare("UPDATE $tabla SET usuario = :usuario, password = :password, email = :email, rol = :rol, photo = :photo WHERE id = :id");	
